...
<pre style="font-family: SFMono-Regular, Consolas, &quot;Liberation Mono&quot;, Menlo, Courier, monospace, Bangla975, sans-serif;"><strong>Input:</strong> 
Employee table:
+----+-------+--------+-----------+
